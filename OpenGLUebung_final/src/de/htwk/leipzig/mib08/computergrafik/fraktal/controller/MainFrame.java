	...
	public MainFrame() {
		...
		Dreiecke.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (Pyramiden.isSelected())
					Pyramiden.setSelected(false);
				Dreieck.mode = 0;
				gp.display();
			}
		});
		...
		rekTiefe1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (rekTiefe2.isSelected())
					rekTiefe2.setSelected(false);
				if (rekTiefe3.isSelected())
					rekTiefe3.setSelected(false);
				if (rekTiefe4.isSelected())
					rekTiefe4.setSelected(false);
				if (rekTiefe5.isSelected())
